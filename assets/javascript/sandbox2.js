...
window.onload = function() {
    ...
    var attackers = document.querySelectorAll(".setAttacker");
    
    for(let _attacker of attackers){
        _attacker.addEventListener("click", function(){
            console.log(this);
        });
    }
...
// $(document).ready(function () {
    ...
    ////////////////////////////////////////////////////////////////////////////////////
    // get a collection with all attackers
    
    
    
    // get collection with all enemies
    //let enemies = document.getElementsByClassName("setEnemy");

    // document.getElementsByClassName("setAttacker")[0].addEventListener("click",function(){
        // alert("test");
    // });
